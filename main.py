...
lip = wp().cylinder(1, socket_radius + 1).cut(cq.Workplane("XY").cylinder(1, ball_radius + 0.2)).translate((0, 0, 5.5))
lip = lip.edges(">Z").chamfer(0.5)
...
socket = rotate_around_x(socket, -10)
